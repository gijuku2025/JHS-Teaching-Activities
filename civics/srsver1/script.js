...
const CHAPTER_FILES = ["chapter1", "chapter2", "chapter3", "chapter4", "chapter5", "chapter6", "chapter7", "chapter8", "chapter9", "chapter10", "chapter11", "chapter12", "chapter13", "chapter15", "chapter16", "chapter17", "chapter18", "chapter19", "chapter20", "chapter21", "chapter22", "chapter23", "chapter24", "chapter25", "chapter26", "chapter27", "chapter28", "chapter29", "chapter30", "chapter31", "chapter32", "chapter33", "chapter34", "chapter35", "chapter36", "chapter37", "chapter38", "chapter39", "chapter40"]; // add more later
...
function showChapterScreen() {
  ...
  CHAPTER_FILES.forEach(ch => {
    const checked = state.activeChapters.includes(ch) ? "checked" : "";
    html += `<label><input type="checkbox" value="${ch}" ${checked}> ${ch}</label><br>`;
  });
...
async function startStudy() {
  ...
  state.activeChapters = Array.from(boxes).filter(b => b.checked).map(b => b.value);
  save();
